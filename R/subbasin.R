...
### CALCULATIONS ###
  ...
  ### calc stream segments or use user defined input
    if(is.null(river)) {
      ...
      # thin
      execGRASS("r.thin", input=paste0(stream, "_rast"), output=paste0(stream, "_thin_t"), flags = "overwrite")
      # convert to vector
      execGRASS("r.to.vect", input=paste0(stream, "_thin_t"), output=paste0(stream, "_vect"), feature="line", flags = "overwrite")
